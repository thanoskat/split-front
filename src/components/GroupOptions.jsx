...
// console.log(store.getState().mainReducer.selectedGroup.creator)
// console.log(store.getState().authReducer.sessionData.userId)
...
export default function GroupOptions({ openMenu }) {
  ...
  return (
    <div className='bottom-menu top-radius flex column' style={{ zIndex: '2', gap: '14px', padding: '14px' }}>
      ...
      {store.getState().mainReducer.selectedGroup.creator === store.getState().authReducer.sessionData.userId &&
      <div
