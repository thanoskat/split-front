  ...
  return (
    <div className='bottom-menu-new top-radius' style={{ zIndex: '2' }}>
      ...
      <div className='flex column gap10 padding1010'>
        ...
        <div className='flex row alignitems-center gap10' style={{marginBottom:"10px"}} onClick={() => setSearchParams({ menu: 'newexpense' })}>
        ...
        <div className='flex row alignitems-center gap10' style={{marginBottom:"10px"}} onClick={() => setSearchParams({ menu: 'recordtransfer' })}>
          <div className='encircle-item'>
